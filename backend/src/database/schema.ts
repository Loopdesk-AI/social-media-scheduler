...
// Enums
export const stateEnum = pgEnum('state', ['QUEUE', 'PUBLISHED', 'ERROR', 'DRAFT']);
...
export const integrations = pgTable('integrations', {
  ...
  uniqueIndex('integrations_user_internal_idx').on(table.userId, table.internalId),
...
export const analytics = pgTable('analytics', {
  ...
  uniqueIndex('analytics_integration_date_platform_idx').on(table.integrationId, table.date, table.platform),
